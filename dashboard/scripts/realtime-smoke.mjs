...
console.log(
  ...
  email,
  "(producer_id",
  "0d0d0000-0000-4000-8000-000000000001)"
);

const received = new Promise((resolve, reject) => {
  const timeout = setTimeout(
    () => reject(new Error("realtime timeout (15s)")),
    15000
  );
  client
    .channel("smoke-test")
...
const { error: insErr } = await client.from("sensor_logs").insert({
